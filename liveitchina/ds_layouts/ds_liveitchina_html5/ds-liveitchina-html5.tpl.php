 ...
 */
?>
<div class="ds-liveitchina-html5 <?php print $classes;?> clearfix">
  ...
  <?php if ($left): ?>
    <aside class="grid-5 alpha omega group-left<?php print $left_classes; ?>">
      <?php print $left; ?>
    </aside>
  <?php endif; ?>

  <?php if ($right): ?>
    <section class="grid-11 omega group-right<?php print $right_classes; ?>">
      <?php print $right; ?>
    </section>
  <?php endif; ?>
    </div>
